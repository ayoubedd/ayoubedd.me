<script lang="ts">
	...
	import { articles as query } from 'siteConfig';
	import Link from '$lib/components/Link.svelte';
	import ProjectCard from '$lib/components/ProjectCard.svelte';

	const articles = query.slice(0, 5);
</script>
...
<section>
	...
	<p>
		...
		<Link href={author.socials[0].url}
			><svg class="github_icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
				><path
